 ...
 */
class _01_VelocityDirectlyGradual extends Tutorial{

  override val name: String = "Box2d - Constant Speed 01 (Gradual Velocity)"
  ...
  override def step() {
    ...
    val xVel = moveState match{
      ...
      case MoveState.Right => Math.min(vel.x+0.1f,5f)
    }
...
object _01_VelocityDirectlyGradual {
  def main(args: Array[String]) {
    Tutorial.demo(new _01_VelocityDirectlyGradual)
  }
}
