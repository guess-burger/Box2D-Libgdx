 ...
 */
class _02_ForcesA extends Tutorial{

  override val name: String = "Box2d - Constant Speed 02 (ForcesA)"
  ...
  override def step() {
    ...
    val force = moveState match{
      case MoveState.Left if  vel.x > -5  => -50f
      case MoveState.Stop => vel.x * -10
      case MoveState.Right if  vel.x <  5 => 50f
      case _ => 0f
    }
